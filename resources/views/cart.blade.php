                      ...
                      <table class="table">
                          ...
                          <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cart-product-name"><img src="{{ $cartItem['img']}}" width="100px"></td>
                                    <td class="cart-product-name"><a href="javascript:void(0)"> {{ $cartItem['name'] }}</a></td>
                                    <td class="product-price">{{ $cartItem['price'] }}<span class="amount"></span></td>
                                    <td class="quantity">
