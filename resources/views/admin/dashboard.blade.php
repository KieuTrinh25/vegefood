                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="statistics-details d-flex align-items-center justify-content-between">
                                <div>
                                    <p class="statistics-title">Tổng số mã giảm giá</p>
                                    <h3 class="rate-percentage">{{$voucher_count}}</h3>

                                </div>
                                <div>
                                    <p class="statistics-title">Tổng sản phẩm</p>
                                    <h3 class="rate-percentage">{{$product_count}}</h3>
                                </div>
                                <div>
                                    <p class="statistics-title">Tổng số khách hàng</p>
                                    <h3 class="rate-percentage">{{$cus_count}}</h3>
